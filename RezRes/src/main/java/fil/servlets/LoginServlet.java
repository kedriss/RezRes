...
public class LoginServlet extends HttpServlet {
	...
	protected void handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(pathInfo+"==/out =");
		System.out.println(pathInfo=="/out");
	...
	private void checkSession(HttpServletResponse response, HttpSession session)
			throws IOException {
		if(isConnected(session))
		{ 
			if(isAdmin(session))
	...
	private void checkLoginPwd(HttpServletRequest request, HttpSession session, HttpServletResponse response) throws ServletException, IOException {
		...
		if( login != null){ // recherche d'une concordance avec login et mot de passe
	...
	private void redirectOnLoginPage(HttpServletRequest request,
			ServletResponse response) throws ServletException, IOException {
		
		System.out.println("redirection vars login.jsp");
